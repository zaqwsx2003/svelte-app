...
<div class="container">
    ...
    <h2>Svelte로 만든 Todo App</h2>
    <input type="text" class="todo-input" placeholder="오늘 할 일은 무엇인가요?" bind:value={newTodoTitle} on:keydown={addTodo} >
    ...
    <div class="inner-container">
        <div><label><input class="inner-container-input" type="checkbox" on:change={checkAllTodos}>모두 체크하기</label></div>
    ...
    <div class="inner-container">
        ...
        <dir>
            <button on:click={clearCompleted}>지우기</button>
        </dir>
    </div>
